...
macOS with [Homebrew](http://brew.sh/) installed:
```
brew install node
```

Linux, you can simply run:
...
A quick overview of the JSONResume theme files:
...
The default boilerplate theme uses [Handlebars](http://handlebarsjs.com/).
